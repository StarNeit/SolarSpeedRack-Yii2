...
(function(){
    ...
    app.service('SharedCalculator',['CalculatorService', 'ConfigService', function(CalculatorService, config){
        ...
        this.getParts = function (safeZones) {
            var exist = [], ret = {}, m;
            ret.endClamps = [];
            ret.midClamps = [];
            ret.clips = [];
            ...
            for(var i in safeZones) {
                if(exist[safeZones[i]]) {
                    ...
                    m = d3.bisectLeft(safeZones, safeZones[i]);
        ...
        var railModel = function(t) {
            return {
                ...
                addSafeZones: function (s) {
                    this.safeZones = d3.merge([this.safeZones, s]);
                },
            };
        };
        ...
        this.addRail = function (layout, nr, i, j, safeZones) {
            if(!safeZones) {
