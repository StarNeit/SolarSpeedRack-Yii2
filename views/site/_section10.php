...
<div class="project-appointments">
    <h1 class="project-appointments__heading project-appointments__heading_padd">Your Project Has Been<br>Assigned For Installation</h1>
    ...
    <p class="project-appointments__text">Your project has been assigned for installation</p>
