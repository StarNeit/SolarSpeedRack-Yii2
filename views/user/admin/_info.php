...
<?php $this->beginContent('@dektrium/user/views/admin/update.php', ['user' => $user]) ?>
    ...
    <table class="table">
        <tr>
            ...
            <td><?= date('M d, Y H:m', $user->created_at) ?></td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-success"><?= Yii::t('user', 'Confirmed at ') . date('M d, Y H:m', $user->created_at) ?></td>
            <?php else: ?>
        ...
        <tr>
            ...
            <td class="text-danger"><?= Yii::t('user', 'Blocked at ') . date('M d, Y H:m', $user->blocked_at) ?></td>
            <?php else: ?>
