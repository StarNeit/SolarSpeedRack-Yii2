...
<div class="item col-md-6">
    ...
    <div class="row pdesc">
        <div class="col-sm-6">
            <p><b>Order #: </b> <?= $model->order ? $model->order->id : ''?> </p>
            <p><b>Order Date: </b> <?= $model->order ? date('m/d/Y', strtotime($model->order->date_purchased)) : '' ?> </p>
            <p><b>Order Amount: </b> <?= $model->order ? $model->order->amount : '' ?> </p>
            <p><b>Ship Date: </b> <?= $model->order ? date('m/d/Y', strtotime($model->order->ship_date)) : '' ?> </p>
        </div>
        <div class="col-sm-6">
            <p><b>Total Watts: </b> <?= $model->total_watt ?></p>
            <p><b>Total Materials: </b><?= $model->total_material ?></p>
            <p><b>Cost Per Watt: </b>$ <?= $model->cost_per_watt ?></p>
            <p>
