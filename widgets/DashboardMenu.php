 ...
 */
class DashboardMenu extends \yii\base\Widget
{
    /**
...
//                ],
                [
                    'label' => 'User',
                    'url' => ['/user/admin'],
                    'img' => 'c-panel-user.png',
                    'active' => $cid == 'admin'
                ],
//                [
//                    'label' => 'Reports',
//                    'url' => ['/manage/reports/index'],
//                    'img' => 'c-panel-reports.png',
//                    'active' => $cid == 'product'
//                ],
                [
                    'label' => 'Products',
                    'url' => ['/manage/product'],
                    'img' => 'c-panel-products.png',
                    'active' => $cid == 'product'
                ],
                [
                    'label' => 'Vendors',
                    'url' => ['/manage/supplier'],
                    'img' => 'c-panel-vendors.png',
                    'active' => $cid == 'supplier'
                ]
    ...
    public function run() 
    {
        return $this->render('dashboardMenu', [
            'items'=> $this->items
        ]);
    }
}
